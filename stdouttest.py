...
if __name__ == "__main__":
   ...
   while True:
	   ...
	   lcd.clear()
	   lcd.message('Device is ready!\n{t.bold}1{t.normal}. Calibrate\n{t.bold}2{t.normal}. Measure\n{t.bold}3{t.normal}. Quit'.format(t=term))
	   #lcd.message('{t.bold}2{t.normal}. Measure\n{t.bold}3{t.normal}. Quit\n'.format(t=term))
